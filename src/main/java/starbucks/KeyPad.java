...
public class KeyPad implements ITouchEventHandler, IDisplayComponent, IKeyPadSubject
{
    ...
    public ArrayList<IKeyPadObserver> getObservers() {
		return observers;
	}


	public void setObservers(ArrayList<IKeyPadObserver> observers) {
    ...
    */
	...
	public int getCountPinDigits() {
		return countPinDigits;
	}


	public void setCountPinDigits(int countPinDigits) {
		this.countPinDigits = countPinDigits;
	}    
