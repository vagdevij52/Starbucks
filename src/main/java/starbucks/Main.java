...
final class Main {
    ...
    public static void main(final String[] args) throws Exception {
        System.err.println("Creating Device instance");
        ...
        for (;;) {
            ...
            if ( cmd.startsWith("touch") ) {
                ...
                api.ping();
            } else if ( cmd.startsWith("getcards") ){
                api.getCards();
            } else if ( cmd.startsWith("getorder") ){
                api.getOrders();
            } else if ( cmd.startsWith("clearorders") ){
                api.clearOrders();
            } else if ( cmd.startsWith("clearcards") ){
                api.clearCards();
            } else if ( cmd.startsWith("newcard") ){
                try{
